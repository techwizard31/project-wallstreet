...
function About() {
  return (
    <div>
      <div className="text-blue-600 text-6xl flex justify-center p-10">About Us</div>
      <div className="p-16 pt-10 font-serif flex justify-center pb-16 text-center">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 m-10 text-center">
        <div className="p-4 flex flex-col justify-between h-full">
          ...
          <span className="block text-blue-600 sm:text-4xl text-xl md:text-4xl mt-4">STUDENTS</span>
        </div>
        <div className="p-4 flex flex-col justify-between h-full">
          <div className="flex flex-col items-center gap-4">
            <Image
          ...
          <span className="block text-blue-600 sm:text-4xl text-xl md:text-4xl mt-4">SPEAKERS</span>
        </div>
        <div className="p-4 flex flex-col justify-between h-full">
          <div className="flex flex-col items-center gap-4">
            <Image
          ...
          <span className="block text-blue-600 sm:text-4xl text-xl md:text-4xl mt-4">STARTUPS</span>
        </div>
        <div className="p-4 flex flex-col justify-between h-full">
          <div className="flex flex-col items-center gap-4">
            <Image
          ...
          <span className="block text-blue-600 sm:text-4xl text-xl md:text-4xl mt-4">INVESTORS</span>
        </div>
      </div>
    </div>
  );
